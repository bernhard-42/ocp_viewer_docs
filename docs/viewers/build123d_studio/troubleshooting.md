...
| Completion or squiggles are stale after installing something | The three environment actions restart the language server themselves. If it did not come back, the splash said so; re-open Settings and press **Install packages** again       |
